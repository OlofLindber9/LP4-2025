...
def murmur3_32(key, seed):
    ...
    # To this end, you should encode all strings into UTF-8 byte sequences before hashing 
    # (the inputs are assumed to be Unicode strings). 
    # Also, you must use bitwise operations on integers.
